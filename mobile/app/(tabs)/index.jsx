import { View, ScrollView, RefreshControl, TouchableOpacity,Text, FlatList } from 'react-native';
...
const HomeScreen = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const transformedFeatured = MealAPI.transformMealData(featuredMeal[0]);
                        ...
                        <View style={homeStyles.featuredMeta}>
                          ...
                          <View style={homeStyles.metaItem}>
                             <Ionicons name='people-outline' size={16} color={COLORS.white}/>
                              <Text style={homeStyles.metaText}>{featuredRecipe.serving}</Text>
                          </View>
                          {featuredRecipe.area &&(
                            <View style={homeStyles.metaItem}>
